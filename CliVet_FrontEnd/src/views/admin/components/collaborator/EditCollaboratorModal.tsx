...
export default function EditCollaboratorModal({ isOpen, onClose } : EditCollaboratorModalProps) {
    ...
    return (
        ...
        >
            ...
            >
                ...
                <h3 className="text-lg font-bold border-b pb-2">Editar colaborador</h3>
